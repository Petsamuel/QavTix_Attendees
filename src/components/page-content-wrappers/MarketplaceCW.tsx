...
export default function MarketplacePageCW({ initialData, categories }: Props) {
    ...
    const renderContent = () => {
        ...
        return (
            <div className="grid p-1 grid-cols-[repeat(auto-fill,minmax(14em,1fr))] md:grid-cols-3 lg:grid-cols-[repeat(auto-fill,minmax(14em,1fr))] gap-y-6 gap-x-4 justify-items-center md:justify-items-start">
                {items.map(event => (
