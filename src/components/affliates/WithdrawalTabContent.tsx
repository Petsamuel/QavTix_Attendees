...
export default function WithdrawalTabContent() {

    
    const [showHistory, setShowHistory] = useState<boolean>(true)
    const [showWithdrawalModal, setShowWithdrawalModal] = useState<boolean>(true)
                ...
                <div className="mt-8 px-1">
                    ...
                    <div className="mb-6 rounded-md px-3 items-center h-12 bg-[#F2F2F2] flex gap-2 border-[1.5px] border-transparent focus-within:border-brand-primary-4 hover:border-brand-primary-4 transition-all">
                        ...
                        <input
                            ...
                            placeholder="0.00"
                            className="flex-1 text-sm text-gray-700 placeholder:text-brand-secondary-3 outline-none bg-transparent"
                        />
                    </div>
                    <Button onClick={() => setShowWithdrawalModal(true)} disabled={!amount} className="h-12 bg-brand-primary-6 hover:bg-brand-primary-7 text-white shadow-sm w-full font-semibold">
